...
```shell
# Get example app
$ go get -u github.com/reechou/erp
...
# Run Application
$ cd $GOPATH/src/github.com/reechou/erp
$ go run main.go
```
...
[Qor Example admin configuration](https://github.com/reechou/erp/blob/master/config/admin/admin.go)

Online Demo Website: [demo.getqor.com/admin](http://demo.getqor.com/admin)

## RESTful API

[Qor Example API configuration](https://github.com/reechou/erp/blob/master/config/api/api.go)
